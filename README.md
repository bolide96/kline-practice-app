...
這是一個可直接上傳 GitHub Pages 的靜態網站，也可安裝到手機或電腦桌面。v2 已加入完整 K 線教學圖、詳細文字教學與圖片下載功能。
...
- 頁面改成「網路優先」，GitHub 更新後不會一直卡在舊版。
- 首頁顯示「版本 v3・完整教學版」，方便確認版本。
- 新增 `reset.html`，可一鍵清除舊 Service Worker 與快取。
- 首頁底部新增「清除舊快取並載入最新版」按鈕。
